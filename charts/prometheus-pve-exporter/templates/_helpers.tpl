...
*/}}
{{- define "prometheus-pve-exporter.configMapName" -}}
{{- printf "%s-config" (include "prometheus-pve-exporter.fullname" .) }}
{{- end }}

{{/*
Create the name of the secret to use
*/}}
{{- define "prometheus-pve-exporter.serviceName" -}}
{{- printf "%s-metrics" (include "prometheus-pve-exporter.fullname" .) }}
{{- end }}
